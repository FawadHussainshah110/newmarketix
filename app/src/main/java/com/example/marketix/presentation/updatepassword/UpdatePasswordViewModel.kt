...
) : BaseViewModel<UpdatePasswordActivityListener>() {

    private val TAG = UpdatePasswordViewModel::class.java.name

    lateinit var listener: UpdatePasswordActivityListener
